            ...
            <div className={'navbar_searchbar'}>
              ...
              <div className={'navbar_top_categories'}>
                ...
                <ul className={'navbar_categories_menu-all'}>
                  ...
                  <li className={'navbar_categories_menu'}>
                    <Link to="/Partner" className={'navbar_categories_item'}>хамкорлар</Link>
                  </li>
                  <li className={'navbar_categories_menu'}>
                    <Link to="/About" className={'navbar_categories_item'}>Биз хакимизда</Link>
                  </li>
                  <li className={'navbar_categories_menu'}>
                    <Link to="/Contact" className={'navbar_categories_item'}>Алока</Link>
                  </li>
                </ul>
              </div>
            </div>
